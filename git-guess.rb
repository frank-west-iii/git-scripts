...
def main
  no_branch_provided_error unless guess
...
def no_branch_provided_error
  puts "You must supply a partial branch name."
  puts "e.g. git guess partial-branch-name"
end

def branches
  @branches ||= `git branch`.split.select do |branch|
